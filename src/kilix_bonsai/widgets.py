"""The two widgets all three tools need: a line editor and a scrollback.

Both exist because a chat box, a prompt box, and a transcript pane are the same
two problems three times over. Keeping them here means one set of editing keys
across the tools, and one place where the awkward parts — wrapping, clamping a
scroll offset to content that changed under it, a cursor that must stay visible
— are got right.
"""
